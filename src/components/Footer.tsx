        ...
        <footer className="bg-black/40 border-t border-white/10 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-2 mb-6">
                            <div className="w-8 h-8 rounded-full border border-primary/50 overflow-hidden">
                                <img src="/img/brand/brand.png" alt="Logo" className="w-full h-full object-cover" />
                            </div>
                            <span className="text-xl font-bold font-heading">BuhoSoft</span>
                        </div>
                        <p className="text-muted-foreground max-w-sm">
                            Empoderando negocios con soluciones digitales innovadoras. Construimos el futuro de la web.
                        </p>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 text-center text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} BuhoSoft. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
